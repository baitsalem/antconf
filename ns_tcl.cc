...
\"\n\
checkout_executable TCLSH \"/home/boussad/Bureau/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/boussad/Bureau/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
set antconfonly [string first \"ANTCONF\" [$agent info class]] \n\
if {$antconfonly != -1 } {\n\
$agent if-queue [$self set ifq_(0)]   ;# ifq between LL and MAC\n\
}\n\
\n\
...
\n\
Agent/ANTCONF instproc init args {\n\
\n\
$self next $args\n\
}\n\
\n\
Agent/ANTCONF set sport_   0\n\
Agent/ANTCONF set dport_   0\n\
\n\
...
ANTCONF {\n\
set ragent [$self create-antconf-agent $node]\n\
}\n\
\n\
DSDV {\n\
...
\n\
Simulator instproc create-antconf-agent { node } {\n\
set ragent [new Agent/ANTCONF [$node node-addr]]\n\
